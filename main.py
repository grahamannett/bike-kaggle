# guide
# https://github.com/chrisclark/PythonForDataScience/blob/master/makeSubmission.py
# from tutorial: http://blog.kaggle.com/2012/07/02/up-and-running-with-python-my-first-kaggle-entry/
